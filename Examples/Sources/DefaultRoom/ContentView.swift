        ...
        NavigationView {
            List {
                    ...
                    .onTapGesture {
                        if skyway.isJoined {
                            ...
                            Task {
                                ...
                                if let _memberId = try? await skyway.joinRoom(roomName: roomNameText, roomType: .default) {
                                    memberId = _memberId
                                }
                ...
                Section {
                    ...
                    skyway.toggleVideoEncoding(roomType: .default)
                }
                Section {
            ...
            .navigationTitle("SkyWay Example: Default Room")
