...
@objc open class P2PRoom: Room {
    ...
    /// - Returns: Member
    @available(iOS 13.0, *)
    @objc public override func join(with options: Room.MemberInitOptions?) async throws -> LocalP2PRoomMember {
    ...
    ///   - completion: 完了コールバック
    @objc public override func join(with options: MemberInitOptions?, completion:((LocalP2PRoomMember?, Error?) -> Void)?) {
