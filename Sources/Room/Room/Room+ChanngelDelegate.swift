...
extension Room: ChannelDelegate {
    ...
    public func channel(_ channel: Channel, publication: Publication, metadataDidUpdate metadata: String) {
        delegate?.room?(self, publication: publication.toRoomPublication(self), metadataDidUpdate: metadata)
    }
