...
@objc public protocol LocalRoomMemberDelegate: RoomMemberDelegate{
    ...
    @objc optional func localRoomMember(_ member: LocalRoomMember, didPublishStreamOf publication: RoomPublication)
    ...
    @objc optional func localRoomMember(_ member: LocalRoomMember, didUnpublishStreamOf publication: RoomPublication)
    ...
    @objc optional func localRoomMember(_ member: LocalRoomMember, didSubscribePublicationOf subscription: RoomSubscription)
    ...
    @objc optional func localRoomMember(_ member: LocalRoomMember, didUnsubscribePublicationOf subscription: RoomSubscription)
}
