...
extension LocalRoomMember: LocalPersonDelegate {
    ...
    public func localPerson(_ localPerson: LocalPerson, didUnpublishStreamOf publication: Publication) {
        delegate?.localRoomMember?(self, didUnpublishStreamOf: publication.toRoomPublication(room))
    }
    
    public func localPerson(_ localPerson: LocalPerson, didSubscribePublicationOf subscription: Subscription) {
        delegate?.localRoomMember?(self, didSubscribePublicationOf: subscription.toRoomSubscription(room))
    }
    
    public func localPerson(_ localPerson: LocalPerson, didUnsubscribePublicationOf subscription: Subscription) {
        delegate?.localRoomMember?(self, didUnsubscribePublicationOf: subscription.toRoomSubscription(room))
    }
