...
extension SFURoom {
    ...
    override public func channel(
        _ channel: Channel,
        publicationDidChangeToEnabled publication: Publication
    ) {
        guard publication.origin != nil else {
            return
        }
    ...
    override public func channel(
        _ channel: Channel,
        publicationDidChangeToDisabled publication: Publication
    ) {
        guard publication.origin != nil else {
            return
        }
    ...
    override public func channel(
        ...
        guard
            let relayedPublication = channel.publications.first(where: { pub in
