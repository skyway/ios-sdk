...
@optional
-(void)localPerson:(SKWLocalPerson* _Nonnull)localPerson didPublishStreamOfPublication:(SKWPublication* _Nonnull)publication;
-(void)localPerson:(SKWLocalPerson* _Nonnull)localPerson didUnpublishStreamOfPublication:(SKWPublication* _Nonnull)publication;
-(void)localPerson:(SKWLocalPerson* _Nonnull)localPerson didSubscribePublicationOfSubscription:(SKWSubscription* _Nonnull)subscription;
-(void)localPerson:(SKWLocalPerson* _Nonnull)localPerson didUnsubscribePublicationOfSubscription:(SKWSubscription* _Nonnull)subscription;
@end
