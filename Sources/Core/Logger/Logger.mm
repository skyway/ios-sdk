...
- (void)debugWithMessage:(NSString*)message
                ...
                function:(NSString*)function
                    line:(int)line;
- (void)logMessageWithLevel:(LoggerInterface::Level)level
...
- (void)traceWithMessage:(NSString*)message
    ...
    if (_level == skyway::global::interface::Logger::kTrace) {
        [self logMessageWithLevel:skyway::global::interface::Logger::kTrace
                          message:message
                         filename:filename
                         function:function
                             line:line];
...
- (void)debugWithMessage:(NSString*)message
    ...
    if (_level == skyway::global::interface::Logger::kTrace ||
        ...
        [self logMessageWithLevel:skyway::global::interface::Logger::kDebug
                          message:message
                         filename:filename
                         function:function
                             line:line];
...
- (void)infoWithMessage:(NSString*)message
    ...
    if (_level == skyway::global::interface::Logger::kTrace ||
        ...
        [self logMessageWithLevel:skyway::global::interface::Logger::kInfo
                          message:message
                         filename:filename
                         function:function
                             line:line];
...
- (void)warnWithMessage:(NSString*)message
    ...
    if (_level == skyway::global::interface::Logger::kTrace ||
        ...
        [self logMessageWithLevel:skyway::global::interface::Logger::kWarn
                          message:message
                         filename:filename
                         function:function
                             line:line];
...
- (void)errorWithMessage:(NSString*)message
    ...
    if (_level == skyway::global::interface::Logger::kTrace ||
        ...
        [self logMessageWithLevel:skyway::global::interface::Logger::kError
                          message:message
                         filename:filename
                         function:function
                             line:line];
...
class Logger::Impl {
public:
    Impl(LoggerInterface::Level level)
        : delegator_([[LoggerDelegator alloc] initWithLevel:level]) {}
