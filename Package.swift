...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SkyWayRoom",
            url: "https://github.com/skyway/ios-sdk/releases/download/3.6.1/SkyWayRoom.xcframework.zip",
            checksum: "71c918097ca241148e7a0d2b656a20fc9290b8d575b7dbb6c525aca991f186c2"),
        .binaryTarget(
            name: "WebRTC",
