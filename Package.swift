...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SkyWayRoom",
            url: "https://github.com/skyway/ios-sdk/releases/download/3.4.0/SkyWayRoom.xcframework.zip",
            checksum: "3b6c966a35ed2bbf245ea97f3ab121c1c662d071a86802a77e1c9e82e56a0d8b"),
        .binaryTarget(
            name: "WebRTC",
