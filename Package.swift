...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SkyWayRoom",
            url: "https://github.com/skyway/ios-sdk/releases/download/3.7.0/SkyWayRoom.xcframework.zip",
            checksum: "031c5f254f02d9544a1779fe07055ca6c299dc83a60fd9d916c82e5e1e77d7fd"),
        .binaryTarget(
            name: "WebRTC",
