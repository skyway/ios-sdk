...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SkyWayRoom",
            url: "https://github.com/skyway/ios-sdk/releases/download/3.5.0/SkyWayRoom.xcframework.zip",
            checksum: "66f4484171812420ad366f02ba5761ebc949ed9b83fd027348961b3a9625fb79"),
        .binaryTarget(
            name: "WebRTC",
