...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SkyWayRoom",
            url: "https://github.com/skyway/ios-sdk/releases/download/3.6.0/SkyWayRoom.xcframework.zip",
            checksum: "7835292dad8e3d8af8d1c9505ee9f81c71d5567a79d9c1e92a746b84af702f1a"),
        .binaryTarget(
            name: "WebRTC",
