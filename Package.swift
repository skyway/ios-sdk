...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SkyWayRoom",
            url: "https://github.com/skyway/ios-sdk/releases/download/4.1.0/SkyWayRoom.xcframework.zip",
            checksum: "1a75238d23fc89fa23fcbbfcb829a0a1cc218c789969a8bb10455abe9524a327"),
        .binaryTarget(
            name: "WebRTC",
