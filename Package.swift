...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SkyWayRoom",
            url: "https://github.com/skyway/ios-sdk/releases/download/3.2.0/SkyWayRoom.xcframework.zip",
            checksum: "185cd3fac223f712e9c0d57b801619749bad3f75f7954fc34fee92394b6aec7f"),
        .binaryTarget(
            name: "WebRTC",
